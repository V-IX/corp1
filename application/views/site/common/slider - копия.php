...
<div class="offer-slider-wrap mb30">
	<div class="wrapper">
				...
				<li>
					...
					<? if($slide['showText'] == 1 or $slide['showBtn'] == 1) { ?>
						<div class="scontent" style="<?=$slide_style;?>">
							...
							<? if($slide['showBtn'] == 1) { ?>
								<div class="sbtn">
									<span class="btn btn-grad"><?=$slide['btnText'];?></span>
								</div>
							<? } ?>
						</div>
					<? } ?>
		...
		<? if(count($slider) > 1) { ?>
			<span class="offer-btn _prev" id="offerPrev" onclick="offer.move(-1)"></span>
			<span class="offer-btn _next" id="offerNext" onclick="offer.move(1)"></span>
